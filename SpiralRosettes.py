...
Totalsides = int(turtle.numinput("Number of sides",
...
for m in range(100):
    ...
    for n in range(Totalsides):
        t.pendown()
        t.pencolor(colors[n%Totalsides])
        t.circle(m/5)
        t.right(360/Totalsides - 2)
        t.width(m/20)
        t.penup()
    ...
    t.left(360/Totalsides + 2)   # move to the next point on the big spiral
